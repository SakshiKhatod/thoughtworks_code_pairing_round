...
from ..models.models import OPENAPI_EXAMPLES, ElectricReading, Readings
...
@router.delete("/clear", description="All readings cleared")
def clear():
    service.clear_all_readings()
    return {"detail": "All readings cleared"}
